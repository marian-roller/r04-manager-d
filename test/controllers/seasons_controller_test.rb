...
class SeasonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post seasons_url, params: { season: { episodes: @season.episodes, movie_id: @season.movie_id, season_no: @season.season_no } }
    end
  ...
  test "should update season" do
    patch season_url(@season), params: { season: { episodes: @season.episodes, movie_id: @season.movie_id, season_no: @season.season_no } }
